...
console.log(AdidasForum84Low.Descripcion)
...
let AdidasForumLow={
    ...
    precio:469990,
    cantidad:2,
    foto:'../assets/img/Adidas Forum Low.jpg',
...
let AdidasOzelia={
    ...
    precio:459990,
    cantidad:1,
    foto:'../assets/img/Adidas Ozelia.jpg',
...
let AdidasPWHuNMD={
    ...
    precio:890990,
    cantidad:2,
    foto:'../assets/img/Adidas PW Hu NMD.png',
...
let AdidasYeezyBoost700MNVN={
    ...
    precio:2500000,
    cantidad:1,
    foto:'../assets/img/Adidas Yeezy Boost 700 MNVN.jpg',
...
let AirJordan6LowCNY={
    ...
    precio:666845,
    cantidad:3,
    foto:'../assets/img/Air Jordan 6 Low CNY.jpg',
...
let ConverseStarPlayer76PremiumCanvas={
    ...
    precio:320000,
    cantidad:3,
    foto:'../assets/img/Converse Star Player 76 Premium Canvas.jpg',
...
let ConverseXToddSnyderChuck70Hi={
    ...
    precio:47900,
    cantidad:4,
    foto:'../assets/img/Converse x Todd Snyder Chuck 70 HI.png',
...
let LacosteL001={
    ...
    precio:31700,
    cantidad:2,
    foto:'../assets/img/Lacoste L001.jpg',
...
let LeCoqSportifTerraJoyeuse={
    ...
    precio:513000,
    cantidad:3,
    foto:'../assets/img/Le Coq Sportif Terra Joyeuse.jpg',
...
let NewBalance530={
    ...
    precio:390000,
    cantidad:5,
    foto:'../assets/img/New Balance 530.jpg',
...
let NewBalance990v4={
    ...
    precio:419000,
    cantidad:2,
    foto:'../assets/img/New Balance 990v4.png',
...
let NewBalanceConversationsAmongstUs={
    ...
    precio:598000,
    cantidad:2,
    foto:'../assets/img/New Balance Conversations Amongst Us.png',
...
let NewBalanceTomKnox440={
    ...
    precio:320000,
    cantidad:1,
    foto:'../assets/img/New Balance Tom Knox 440.jpg',
...
let NewBalanceXC72={
    ...
    precio:557000,
    cantidad:3,
    foto:'../assets/img/New Balance XC-72.jpg',
...
let NikeAirJordan1Mid={
    ...
    precio:533000,
    cantidad:3,
    foto:'../assets/img/Nike Air Jordan 1 Mid.jpg',
    Descripcion:'',
}
let NikeAirMaxTerrascape90={
    ...
    precio:770000,
    cantidad:4,
    foto:'../assets/img/Nike Air Max Terrascape 90.jpg',
...
let NikeBlazerLowXOffWhite={
    ...
    precio:550000,
    cantidad:2,
    foto:'../assets/img/Nike Blazer Low x Off-White.jpg',
...
let NikeBlazerMid77={
    ...
    precio:309000,
    cantidad:4,
    foto:'../assets/img/Nike Blazer Mid 77.jpg',
...
let NikeDunkLow={
    ...
    precio:480000,
    cantidad:2,
    foto:'../assets/img/Nike Dunk Low.jpg',
...
let NikeGoFlyEase={
    ...
    precio:458000,
    cantidad:2,
    foto:'../assets/img/Nike Go FlyEase.png',
...
let NikeXDrakeHotStepAirTerra={
    ...
    precio:2920000,
    cantidad:3,
    foto:'../assets/img/Nike x Drake Hot Step Air Terra.jpg',
...
let ParisHighTopFullDestroyeddeBalenciaga={
    ...
    precio:6200000,
    cantidad:1,
    foto:'../assets/img/Paris High Top Full Destroyed de Balenciaga.jpg',
...
let PradaXAdidasForumHi={
    ...
    precio:3600000,
    cantidad:2,
    foto:'../assets/img/Prada x Adidas Forum Hi.jpg',
...
let PremiataSteven5247={
    ...
    precio:1342000,
    cantidad:1,
    foto:'../assets/img/Premiata Steven 5247.jpg',
...
let ReGroundZetaXNespresso={
    ...
    precio:662000,
    cantidad:1,
    foto:'../assets/img/Re Ground Zèta x Nespresso.jpg',
...
let ReebokClubCRevenge={
    ...
    precio:600000,
    cantidad:2,
    foto:'../assets/img/Reebok Club C Revenge.jpg',
...
let ReebokPremierRoadPlusViXJul={
    ...
    precio:537000,
    cantidad:3,
    foto:'../assets/img/Reebok Premier Road Plus VI X JUL.jpg',
...
let ReebokPumpOmniZoneII={
    ...
    precio:370000,
    cantidad:4,
    foto:'../assets/img/Reebok Pump Omni Zone II.png',
...
let VulcandeTimpers={
    ...
    precio:256000,
    cantidad:1,
    foto:'../assets/img/Vulcan de Timpers.jpg',
...
let VansxCrayola={
    ...
    precio:230000,
    cantidad:3,
    foto:'../assets/img/Vans x Crayola.png',
